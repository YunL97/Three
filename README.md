...
Physics with Rapier: 러스트  프로그래밍 언어용으로 개발된 고성능 3d 물리 엔진인 rapier을 사용하여 물리 시뮬레이션을 구현하는것
* Rapier ImpulseJoint Motors: rapier에서 조인트는 물체 사이의 관절이나 연결점을 나타내며 물체의 상호작용을 정의하는데 사용된다. Rapier ImpulseJoint Motors는 조인트에 대한 원하는 속도, 가속도, 또는 힘을 설정하는데 사용된다.  -> 물리 시뮬레이션에서 조인트의 움직임을 조절할 수 있다